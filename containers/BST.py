...
class BST(BinaryTree):
    ...
    def __repr__(self):
        ...
        string that can be used to recreate a valid instance
        of the class.
    ...
    def __eq__(self, t2):
        ...
        '''
        t_one = self.to_list('inorder')
        t_two = t2.to_list('inorder')
        for a in t_one:
            if a not in t_two:
                return False
        for b in t_two:
    ...
    def _is_bst_satisfied(node):
        ...
        HINT:
        Use the _find_smallest and _find_largest functions to
        fix the bug.
