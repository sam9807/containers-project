'''
This file implements the Node and BinaryTree
classes.
These two classes are the building blocks for
the BST, AVLTree, and Heap data structures.
It is crucial to get these implemented correctly in order to
be able to implement the other data structures.
'''
...
class Node():
    ...
    so you should get familiar with how
    to visualize these strings.
    '''
...
class BinaryTree():
    ...
    and it provides important helper functions
    for these classes.
    If you don't implement all of
    the functions in this class correctly,
    ...
    def print_tree(self, traversal_type):
        ...
        All three of these traversals are implemented for
    ...
    def preorder(self, start, traversal):
        '''
        FIXME:
        Implement this function by modifying the
    ...
    def postorder(self, start, traversal):
        '''
        FIXME:
        Implement this function by modifying the _print
        functions above.
        '''
        if start:
    ...
    def __len__helper(node):
        ...
        if not node:
            return tot
        if node.left:
            tot += BinaryTree.__len__helper(node.left)
        if node.right:
            tot += BinaryTree.__len__helper(node.right)
        return 1 + tot
